  ...
  return (
    <div className="text-center">
      ...
      <p className="text-gray-600 leading-relaxed">
        The easiest way to reach ARK is by email. Click the button below and your mail app will open a new message to us.
      </p>
      <a
        href={`mailto:${siteConfig.contact.email}?subject=${encodeURIComponent('Contact from ARK website')}`}
