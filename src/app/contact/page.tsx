              ...
              <div className="flex gap-4">
                {socialLinks.map(({ label, href, icon }) => (
                  <a
                    ...
                    aria-label={`ARK on ${label}`}
                    className="w-11 h-11 rounded-xl flex items-center justify-center transition-colors hover:opacity-80"
                    style={{ backgroundColor: '#1a3a2a', color: '#e8b84b' }}
                  >
                    {icon}
                  </a>
                ))}
